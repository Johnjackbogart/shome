...
describe("app-style API", () => {
  ...
  it("validates and updates only the signed-in member's app style", async () => {
    ...
    expect(mocks.updateSet).toHaveBeenCalledWith({
      ...
      appAccentBackgroundColor: customized.appAccentBackgroundColor,
      appAccentColor: customized.appAccentColor,
      appSecondaryAccentColor: customized.appSecondaryAccentColor,
      ...
      appAccentFontColor: customized.appAccentFontColor,
