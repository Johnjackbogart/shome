module.exports = [
"[project]/apps/web/node_modules/@better-auth/memory-adapter/dist/index.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const memoryAdapter = (db, config)=>{
	...
	*/ const buildAdapterFactory = (activeDb)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$adapter$2f$factory$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAdapterFactory"])({
            config: {
                adapterId: "memory",
            ...
            adapter: ({ getFieldName, getDefaultFieldName, options, getModelName })=>{
                ...
                function convertWhereClause(where, model, join, select) {
                    const baseRecords = (()=>{
                        ...
                        if (!table) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2f$logger$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error(`[MemoryAdapter] Model ${model} not found in the DB`, Object.keys(activeDb));
                    ...
                    for (const baseRecord of baseRecords){
                        ...
                        for (const [joinModel, joinAttr] of Object.entries(join)){
                            ...
                            if (!joinTable) {
                                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2f$logger$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error(`[MemoryAdapter] JoinOption model ${joinModelName} not found in the DB`, Object.keys(activeDb));
...
//# sourceMappingURL=0rrk_%40better-auth_memory-adapter_dist_index_mjs_1if8knv._.js.map