		...
		"production" !== ("TURBOPACK compile-time value", "development") &&
			(() => {
				...
				var React = __turbopack_context__.r(
					...
					createTask = console.createTask ? console.createTask : () => null;
				React = {
					react_stack_bottom_frame: (callStackForError) => callStackForError(),
				};
				...
				exports.jsx = (type, config, maybeKey) => {
				...
				exports.jsxs = (type, config, maybeKey) => {
					var trackActualOwner =
						1e4 > ReactSharedInternals.recentlyCreatedOwnerStacks++;
					return jsxDEVImpl(
						type,
		...
		"production" !== ("TURBOPACK compile-time value", "development") &&
			(() => {
				...
				for (fnName in deprecatedAPIs)
					Object.hasOwn(deprecatedAPIs, fnName) &&
				...
				deprecatedAPIs = Object.freeze({
					__proto__: null,
					c: (size) => resolveDispatcher().useMemoCache(size),
				});
				var fnName = {
					map: mapChildren,
				...
				exports.cacheSignal = () => null;
				exports.captureOwnerStack = () => {
				...
				exports.unstable_useCacheRefresh = () =>
					resolveDispatcher().useCacheRefresh();
				exports.use = (usable) => resolveDispatcher().use(usable);
				exports.useActionState = (action, initialState, permalink) =>
					resolveDispatcher().useActionState(action, initialState, permalink);
				exports.useCallback = (callback, deps) =>
					resolveDispatcher().useCallback(callback, deps);
				exports.useContext = (Context) => {
				...
				exports.useDebugValue = (value, formatterFn) =>
					resolveDispatcher().useDebugValue(value, formatterFn);
				exports.useDeferredValue = (value, initialValue) =>
				...
				exports.useEffectEvent = (callback) =>
					resolveDispatcher().useEffectEvent(callback);
				exports.useId = () => resolveDispatcher().useId();
				exports.useImperativeHandle = (ref, create, deps) =>
				...
				exports.useMemo = (create, deps) =>
					resolveDispatcher().useMemo(create, deps);
				exports.useOptimistic = (passthrough, reducer) =>
					resolveDispatcher().useOptimistic(passthrough, reducer);
				exports.useReducer = (reducer, initialArg, init) =>
					resolveDispatcher().useReducer(reducer, initialArg, init);
				exports.useRef = (initialValue) =>
					resolveDispatcher().useRef(initialValue);
				exports.useState = (initialState) =>
				...
				exports.useSyncExternalStore = (
					...
					resolveDispatcher().useSyncExternalStore(
						subscribe,
						getSnapshot,
						getServerSnapshot,
					);
	...
	(__turbopack_context__, module, exports) => {
		...
		"production" !== ("TURBOPACK compile-time value", "development") &&
			(() => {
				...
				exports.unstable_cancelCallback = (task) => {
					task.callback = null;
				};
				...
				exports.unstable_getCurrentPriorityLevel = () => currentPriorityLevel;
				exports.unstable_next = (eventHandler) => {
				...
				exports.unstable_runWithPriority = (priorityLevel, eventHandler) => {
				...
				exports.unstable_wrapCallback = (callback) => {
...
//# sourceMappingURL=node_modules_10e2-xo._.js.map
