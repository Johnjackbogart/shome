(globalThis["TURBOPACK"] || (globalThis["TURBOPACK"] = [])).push([
		...
		"trimStart" in String.prototype ||
			...
			Object.fromEntries ||
				(Object.fromEntries = (t) =>
					Array.from(t).reduce((t, r) => ((t[r[0]] = r[1]), t), {})),
			Array.prototype.at ||
		...
		module.exports =
			...
			null
				...
				: __turbopack_context__.r(
						"[project]/node_modules/next/dist/compiled/process/browser.js [client] (ecmascript)",
					);
	},
	...
	(__turbopack_context__, module, exports) => {
		...
		_export(exports, {
			...
			CACHE_ONE_YEAR_SECONDS: () => CACHE_ONE_YEAR_SECONDS,
			...
			HTML_CONTENT_TYPE_HEADER: () => HTML_CONTENT_TYPE_HEADER,
			INFINITE_CACHE: () => INFINITE_CACHE,
			INSTRUMENTATION_HOOK_FILENAME: () => INSTRUMENTATION_HOOK_FILENAME,
			JSON_CONTENT_TYPE_HEADER: () => JSON_CONTENT_TYPE_HEADER,
			...
			NEXT_CACHE_REVALIDATE_TAG_TOKEN_HEADER: () =>
				NEXT_CACHE_REVALIDATE_TAG_TOKEN_HEADER,
			NEXT_CACHE_ROOT_PARAM_TAG_ID: () => NEXT_CACHE_ROOT_PARAM_TAG_ID,
			...
			NEXT_NAV_DEPLOYMENT_ID_HEADER: () => NEXT_NAV_DEPLOYMENT_ID_HEADER,
			NEXT_QUERY_PARAM_PREFIX: () => NEXT_QUERY_PARAM_PREFIX,
			NEXT_RESUME_HEADER: () => NEXT_RESUME_HEADER,
			NEXT_RESUME_STATE_LENGTH_HEADER: () => NEXT_RESUME_STATE_LENGTH_HEADER,
			...
			PROXY_LOCATION_REGEXP: () => PROXY_LOCATION_REGEXP,
			...
			STATIC_STATUS_PAGE_GET_INITIAL_PROPS_ERROR: () =>
				STATIC_STATUS_PAGE_GET_INITIAL_PROPS_ERROR,
			TEXT_PLAIN_CONTENT_TYPE_HEADER: () => TEXT_PLAIN_CONTENT_TYPE_HEADER,
	...
	(__turbopack_context__, module, exports) => {
		...
		function isAPIRoute(value) {
			return (
				value === "/api" ||
				Boolean(value == null ? void 0 : value.startsWith("/api/"))
			);
		}
	},
	...
	(__turbopack_context__, module, exports) => {
		...
		_export(exports, {
			...
			hasAdjacentParameterIssues: () => hasAdjacentParameterIssues,
			normalizeAdjacentParameters: () => normalizeAdjacentParameters,
			normalizeTokensForRegexp: () => normalizeTokensForRegexp,
	...
	"[project]/node_modules/next/dist/next-devtools/shared/forward-logs-shared.js [client] (ecmascript)",
	(__turbopack_context__, module, exports) => {
		"use strict";
		...
		_export(exports, {
			...
			markErrorAsAlreadyLoggedOnServer: () => markErrorAsAlreadyLoggedOnServer,
			patchConsoleMethod: () => patchConsoleMethod,
			wasErrorAlreadyLoggedOnServer: () => wasErrorAlreadyLoggedOnServer,
		});
		...
		function wasErrorAlreadyLoggedOnServer(value) {
			return (
				typeof value === "object" &&
				value !== null &&
				value[alreadyLoggedOnServerSymbol] === true
			);
		}
	...
	"[project]/node_modules/next/dist/next-devtools/shared/react-18-hydration-error.js [client] (ecmascript)",
	(__turbopack_context__, module, exports) => {
		"use strict";
		...
		_export(exports, {
			getHydrationWarningType: () => getHydrationWarningType,
	...
	"[project]/node_modules/next/dist/next-devtools/shared/react-19-hydration-error.js [client] (ecmascript)",
	(__turbopack_context__, module, exports) => {
		"use strict";
		...
		_export(exports, {
			NEXTJS_HYDRATION_ERROR_LINK: () => NEXTJS_HYDRATION_ERROR_LINK,
			REACT_HYDRATION_ERROR_LINK: () => REACT_HYDRATION_ERROR_LINK,
			getHydrationErrorStackInfo: () => getHydrationErrorStackInfo,
			isErrorMessageWithComponentStackDiff: () =>
				isErrorMessageWithComponentStackDiff,
			isHydrationError: () => isHydrationError,
		});
		...
		function isErrorMessageWithComponentStackDiff(msg) {
			return errorMessagesWithComponentStackDiff.some((regex) =>
				regex.test(msg),
			);
		}
	...
	(__turbopack_context__, module, exports) => {
		...
		_export(exports, {
			...
			decorateDevError: () => decorateDevError,
			getOwnerStack: () => getOwnerStack,
			setOwnerStack: () => setOwnerStack,
	...
	"[project]/node_modules/next/dist/next-devtools/userspace/app/forward-logs-utils.js [client] (ecmascript)",
	(__turbopack_context__, module, exports) => {
		"use strict";
		...
		_export(exports, {
			...
			preLogSerializationClone: () => preLogSerializationClone,
			safeStringifyWithDepth: () => safeStringifyWithDepth,
		});
		const _safestablestringify = __turbopack_context__.r(
			"[project]/node_modules/next/dist/compiled/safe-stable-stringify/index.js [client] (ecmascript)",
		);
		const _terminalloggingconfig = __turbopack_context__.r(
			"[project]/node_modules/next/dist/next-devtools/userspace/app/terminal-logging-config.js [client] (ecmascript)",
		);
		const _forwardlogsshared = __turbopack_context__.r(
			"[project]/node_modules/next/dist/next-devtools/shared/forward-logs-shared.js [client] (ecmascript)",
		);
		const terminalLoggingConfig = (0,
		_terminalloggingconfig.getTerminalLoggingConfig)();
	...
	(__turbopack_context__, module, exports) => {
		...
		_export(exports, {
			forwardErrorLog: () => forwardErrorLog,
			forwardUnhandledError: () => forwardUnhandledError,
			initializeDebugLogForwarding: () => initializeDebugLogForwarding,
			logQueue: () => logQueue,
		...
		const isTerminalLoggingEnabled = (0,
		_terminalloggingconfig.getIsTerminalLoggingEnabled)();
		const shouldForwardLogs =
			isTerminalLoggingEnabled || !!("TURBOPACK compile-time value", true);
		const methods = [
			"log",
			"info",
			"warn",
		...
		const forwardErrorLog = (args) => {
			...
			if (
				first &&
				(0, _forwardlogsshared.wasErrorAlreadyLoggedOnServer)(first)
			) {
				return;
			}
			if (first) {
	...
	(__turbopack_context__, module, exports) => {
		...
		_export(exports, {
			getIsTerminalLoggingEnabled: () => getIsTerminalLoggingEnabled,
			getTerminalLoggingConfig: () => getTerminalLoggingConfig,
		});
		function getTerminalLoggingConfig() {
			try {
				return JSON.parse(
					("TURBOPACK compile-time value", '"warn"') || "false",
				);
			} catch {
				return false;
			}
	...
	"[project]/node_modules/next/dist/next-devtools/userspace/pages/hydration-error-state.js [client] (ecmascript)",
	(__turbopack_context__, module, exports) => {
		"use strict";
		...
		_export(exports, {
			attachHydrationErrorState: () => attachHydrationErrorState,
		...
		function attachHydrationErrorState(error) {
			if (
				!(0, _react18hydrationerror.isHydrationError)(error) &&
				!(0, _react19hydrationerror.isHydrationError)(error)
			) {
				return;
			}
		...
		function storeHydrationErrorStateFromConsoleArgs(...args) {
			...
			if ((0, _react18hydrationerror.isHydrationWarning)(message)) {
				...
				(0, _react19hydrationerror.isErrorMessageWithComponentStackDiff)(
					message,
				)
			) {
				// Some hydration warnings has 4 arguments, some has 3, fallback to the last argument
		 ...
		 */ function generateHydrationDiffReact18(
			...
			let firstIndex = -1;
			let secondIndex = -1;
			const hydrationWarningType = (0,
			_react18hydrationerror.getHydrationWarningType)(message);
			// at div\n at Foo\n at Bar (....)\n -> [div, Foo]
			...
			for (let i = 0; i < components.length; i++) {
				...
				const matchFirstContent =
					...
					i === components.length - firstIndex - 1;
	...
	"[project]/node_modules/next/dist/next-devtools/userspace/pages/pages-dev-overlay-error-boundary.js [client] (ecmascript)",
	(__turbopack_context__, module, exports) => {
		"use strict";
	...
	(__turbopack_context__, module, exports) => {
		...
		_export(exports, {
			PagesDevOverlayBridge: () => PagesDevOverlayBridge,
			register: () => register,
		});
		const _interop_require_default = __turbopack_context__.r(
			"[project]/node_modules/@swc/helpers/cjs/_interop_require_default.cjs [client] (ecmascript)",
			...
			_react.default.useEffect(
				{
					"usePagesDevOverlayBridge.useEffect": () => {
						...
						_router.Router.events.on(
							"routeChangeComplete",
							handleStaticIndicator,
						);
						return {
							"usePagesDevOverlayBridge.useEffect": () => {
								_router.Router.events.off(
									"routeChangeComplete",
									handleStaticIndicator,
								);
							},
		...
		function nextJsHandleConsoleError(...args) {
			...
			const maybeError = ("TURBOPACK compile-time truthy", 1)
				? args[1]
				: "TURBOPACK unreachable";
			(0, _hydrationerrorstate.storeHydrationErrorStateFromConsoleArgs)(
				...args,
			);
		...
		function _getInitialProps({ req, res, err }) {
			...
			if (typeof window !== "undefined") {
				...
				const { getRequestMeta } = __turbopack_context__.r(
					"[project]/node_modules/next/dist/server/request-meta.js [client] (ecmascript)",
				);
	...
	(__turbopack_context__, module, exports) => {
		...
		_export(exports, {
			HMR_MESSAGE_SENT_TO_BROWSER: () => HMR_MESSAGE_SENT_TO_BROWSER,
			HMR_MESSAGE_SENT_TO_SERVER: () => HMR_MESSAGE_SENT_TO_SERVER,
		});
		var HMR_MESSAGE_SENT_TO_BROWSER = /*#__PURE__*/ ((
			...
			HMR_MESSAGE_SENT_TO_BROWSER["TURBOPACK_CONNECTED"] =
				"turbopack-connected";
			...
			HMR_MESSAGE_SENT_TO_BROWSER["REQUEST_PAGE_METADATA"] =
				"requestPageMetadata";
			HMR_MESSAGE_SENT_TO_BROWSER["REQUEST_INSIGHTS_UPDATE"] =
			...
			HMR_MESSAGE_SENT_TO_BROWSER[
				(HMR_MESSAGE_SENT_TO_BROWSER["ERRORS_TO_SHOW_IN_BROWSER"] = 1)
			] = "ERRORS_TO_SHOW_IN_BROWSER";
			return HMR_MESSAGE_SENT_TO_BROWSER;
		})({});
		var HMR_MESSAGE_SENT_TO_SERVER = /*#__PURE__*/ ((
	...
	(__turbopack_context__, module, exports) => {
		...
		const _stacktraceparser = __turbopack_context__.r(
			"[project]/node_modules/next/dist/compiled/stacktrace-parser/stack-trace-parser.cjs.js [client] (ecmascript)",
		);
		const _errorsource = __turbopack_context__.r(
			"[project]/node_modules/next/dist/shared/lib/error-source.js [client] (ecmascript)",
		);
		...
		function getServerError(error, type) {
			...
			try {
				n.stack = `${n.toString()}\n${(0, _stacktraceparser.parse)(error.stack)
...
//# sourceMappingURL=node_modules_next_dist_1atto1n._.js.map
