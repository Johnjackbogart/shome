(globalThis["TURBOPACK"] || (globalThis["TURBOPACK"] = [])).push([
	typeof document === "object" ? document.currentScript : undefined,
	{
		...
		runtimeModuleIds: [
			"[project]/node_modules/next/dist/compiled/@next/react-refresh-utils/dist/runtime.js [client] (ecmascript)",
			"[project]/node_modules/next/dist/client/next-dev-turbopack.js [client] (ecmascript)",
			'[hmr-entry]/hmr-entry.js { ENTRY => "[project]/apps/web/pages/_error" }',
		],
	},
]);
(() => {
	...
	var CHUNK_BASE_PATH = "/_next/";
	var RELATIVE_ROOT_PATH = "/ROOT";
	var RUNTIME_PUBLIC_PATH = "/_next/";
	 ...
	 */ var SourceType = /*#__PURE__*/ ((SourceType) => {
		/**
	...
	function chunkUrlToPath(chunkUrl) {
		...
		return src.startsWith(CHUNK_BASE_PATH)
	 ...
	 */ function endsWithExtension(chunkUrlOrPath, ext) {
		...
		return (
			end >= ext.length && chunkUrlOrPath.startsWith(ext, end - ext.length)
		);
	}
		...
		const hot = {
			...
			accept: (modules, callback, errorHandler) => {
				if (modules === undefined) {
					...
					hotState.acceptedDependencies[modules] = callback || (() => {});
	 ...
	 */ function computeOutdatedModules(
		...
		const { outdatedModules, outdatedDependencies } =
			computedInvalidatedModules(modified.keys(), autoAcceptRootModules);
	...
	function applyEcmascriptMergedUpdate(update) {
		...
		const { added, modified, chunksAdded, chunksDeleted } =
			computeChangedModules(entries, chunks, chunkModulesMap);
...
//# sourceMappingURL=apps_web_pages__error_163eltr._.js.map
